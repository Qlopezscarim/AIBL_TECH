...
std::cout << "ENABLING MOTOR 1 FORWARD \tP9_14" << std::endl;
Motors::motorOneForward();
usleep(5000000);
std::cout << "ENABLING MOTOR 1 FORWARD \tP9_14" << std::endl;
Motors::motorOneBackward();
usleep(5000000);
std::cout << "DISABLING MOTOR 1 \tP9_14" << std::endl;
Motors::motorOneDisable();
usleep(5000000);
std::cout << "ENABLING MOTOR 2 FORWARD\tP9_16" << std::endl;
Motors::motorTwoForward();
usleep(5000000);
std::cout << "ENABLING MOTOR 2 BACKWARD\tP9_16" << std::endl;
Motors::motorTwoBackward();
usleep(5000000);
std::cout << "DISABLING MOTOR 2 \tP9_16" << std::endl;
Motors::motorTwoDisable();
usleep(5000000);
std::cout << "ENABLING MOTOR 3 FORWARD\tP8_19" << std::endl;
Motors::motorThreeForward();
usleep(5000000);
std::cout << "ENABLING MOTOR 3 BACKWARD\tP8_19" << std::endl;
Motors::motorThreeBackward();
usleep(5000000);
std::cout << "DISABLING MOTOR 3\tP8_19" << std::endl;
Motors::motorThreeDisable();
usleep(5000000);
std::cout << "ENABLING MOTOR 4 FORWARD\tP8_13" << std::endl;
Motors::motorFourForward();
usleep(5000000);
std::cout << "ENABLING MOTOR 4 BACKWARD\tP8_13" << std::endl;
Motors::motorFourBackward();
usleep(5000000);
std::cout << "DISABLING MOTOR 4\tP8_13" << std::endl;
Motors::motorFourDisable();
usleep(5000000);
std::cout << "ENABLING MOTOR 5 FORWARD\tP9_22" << std::endl;
Motors::motorFiveForward();
usleep(5000000);
std::cout << "ENABLING MOTOR 5 BACKWARD\tP9_22" << std::endl;
Motors::motorFiveBackward();
usleep(5000000);
std::cout << "DISABLING MOTOR 5\tP9_22" << std::endl;
Motors::motorFiveDisable();
usleep(5000000);
std::cout << "ENABLING MOTOR 6 FORWARD\tP9_21" << std::endl;
Motors::motorSixForward();
usleep(5000000);
std::cout << "ENABLING MOTOR 6 BACKWARD\tP9_21" << std::endl;
Motors::motorSixBackward();
usleep(5000000);
